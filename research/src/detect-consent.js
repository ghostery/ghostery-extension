export function detectConsentBanners() {
  ...
  const BUTTON_RX = /\b(?:accept all|reject all|accept (?:&|and) continue|accept cookies|reject cookies|manage (?:cookies|preferences|consent|options|choices)|save (?:preferences|choices|my choices)|do not sell(?: or share)?|customize my (?:choices|preferences)|agree (?:&|and) (?:continue|proceed)|your privacy choices|cookies and similar technologies|under state laws|state privacy (?:notice|choices|supplement)|us state supplement|akceptuj[eę]?(?: wszystkie)?|odrzu[ćc] wszystkie|zaakceptuj|przejd[zź] do serwisu|zarz[aą]dzaj (?:zgodami|preferencjami|ustawieniami)|alle akzeptieren|alle ablehnen|einstellungen verwalten|tout accepter|tout refuser|g[eé]rer mes choix|aceptar todo|rechazar todo|gestionar preferencias|accetta tutto|rifiuta tutto|gestisci preferenze|aceitar tudo|rejeitar tudo)\b/i;
