/**
 * Additional Features View Container
 *
...
import AdditionalFeaturesView from '../../components/Views/AdditionalFeaturesView';
import * as actions from '../../actions/AdditionalFeaturesViewActions';
 ...
 */
const mapStateToProps = (state, ownProps) => Object.assign({}, state.additionalFeatures);
...
export default connect(mapStateToProps, mapDispatchToProps)(AdditionalFeaturesView);
