...
import * as actions from '../../actions/DataCollectionViewActions';
 ...
 */
const mapStateToProps = (state, ownProps) => Object.assign({}, state.dataCollection);
...
export default connect(mapStateToProps, mapDispatchToProps)(DataCollectionView);
