...
const SubscriptionInfo = (props) => {
	const {
		active, charge_date, auto_renewal
			...
			<div className="row">
				<div className="columns column-subscription">
					...
					<div className="status-row">
						...
						<span className="status-value light">{charge_date}</span>
					</div>
					<div className="status-row">
						<span className="status-label light">{`${t('subscription_auto_renewal')}: `}</span>
						<span className="status-value light">{active && auto_renewal ? t('subscription_active') : t('subscription_inactive') }</span>
					</div>
