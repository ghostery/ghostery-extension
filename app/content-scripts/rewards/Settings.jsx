				...
				{!this.state.closed &&
					<div className="rewards-settings-container rewards-popup-container">
						<div className="rewards-settings">
							...
							<a onClick={this.props.signal} href="https://www.ghostery.com/faqs/what-is-ghostery-rewards/" target="_blank" rel="noopener noreferrer" className="about">{t('rewards_about')}</a>
