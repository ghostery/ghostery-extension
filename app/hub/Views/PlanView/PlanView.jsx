...
const basicCard = () => (
	<div className="PlanView__cardOuter">
		<div className="PlanView__card basic" data-equalizer-watch>
...
const plusCard = () => (
	<div className="PlanView__cardOuter">
		<div className="PlanView__card plus" data-equalizer-watch>
...
const premiumCard = () => (
	<div className="PlanView__cardOuter">
		<div className="PlanView__card premium" data-equalizer-watch>
...
const PlanView = () => {
	...
	return (
		<div>
			...
			<div className="PlanView__seeAllPlans" onClick={scrollToPlans}>{t('hub_plan_see_all_plans')}</div>
