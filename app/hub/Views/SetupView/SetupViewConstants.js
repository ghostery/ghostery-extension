...
// Setup View
export const GET_SETUP_SHOW_WARNING_OVERRIDE = 'GET_SETUP_SHOW_WARNING_OVERRIDE';
export const SET_SETUP_SHOW_WARNING_OVERRIDE = 'SET_SETUP_SHOW_WARNING_OVERRIDE';
export const INIT_SETUP_PROPS = 'INIT_SETUP_PROPS';
export const SET_SETUP_NAVIGATION = 'SET_SETUP_NAVIGATION';

// Setup Blocking
export const SET_BLOCKING_POLICY = 'SET_BLOCKING_POLICY';
export const BLOCKING_POLICY_NOTHING = 'BLOCKING_POLICY_NOTHING';
export const BLOCKING_POLICY_RECOMMENDED = 'BLOCKING_POLICY_RECOMMENDED';
