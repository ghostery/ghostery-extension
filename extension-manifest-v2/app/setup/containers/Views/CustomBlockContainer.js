...
import CustomBlockView	 from '../../components/Views/CustomBlockView';
 ...
 */
const mapStateToProps = (state, ownProps) => Object.assign({}, state.blocking, state.settings);
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomBlockView);
