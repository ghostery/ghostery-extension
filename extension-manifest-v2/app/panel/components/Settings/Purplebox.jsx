 ...
 */
function Purplebox({ settingsData, toggleCheckbox, selectItem }) {
	return (
			...
			<div className="row">
				<div className="columns">
					...
					<div className="s-alert-bubble-options dismiss-after-wrap">
						...
						<select id="settings-dismiss-after" name="alert_bubble_timeout" defaultValue={settingsData.alert_bubble_timeout} onChange={selectItem}>
							<option value="0">
								{ t('settings_never') }
							</option>
							<option value="3">
					...
					<div className="s-alert-bubble-options display-in-wrap">
						...
						<select id="settings-display-in" name="alert_bubble_pos" defaultValue={settingsData.alert_bubble_pos} onChange={selectItem}>
							<option value="br">
					...
					<div className="s-option-group">
						<div className="s-square-checkbox">
							<input type="checkbox" id="settings-hide-alert-trusted" name="hide_alert_trusted" defaultChecked={settingsData.hide_alert_trusted} onClick={toggleCheckbox} />
