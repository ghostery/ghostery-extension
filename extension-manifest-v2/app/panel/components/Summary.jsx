		...
		return (
			<div className={summaryClassNames}>
				...
				<div className={foregroundClassNames}>
					...
					<ui-onboarding-state class="Summary__onboardingState" ref={(el) => { if (el) { el.disabled = !setup_complete; el.href = chrome.runtime.getURL('/app/templates/onboarding.html'); } }}>
