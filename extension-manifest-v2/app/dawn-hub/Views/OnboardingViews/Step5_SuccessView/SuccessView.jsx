/**
 * Dawn Hub onboarding flow Success View Component
 *
 ...
 * @return {JSX} JSX for rendering the Browser Success View of the Dawn Hub app
			...
			<div className="SuccessView__relativeContainer">
				<div className="SuccessView__backContainer">
					...
					<NavLink to="/onboarding/4">
						<span className="SuccessView__back">{t('ghostery_dawn_onboarding_back')}</span>
					</NavLink>
				</div>
			</div>
