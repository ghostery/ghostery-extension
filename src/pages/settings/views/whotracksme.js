            ...
            <div layout="row gap:2" layout@768px="gap:3">
              <ui-action>
                ...
                >
                  ...
                  <div layout="column grow gap:0.5">
                    <ui-text type="headline-xs">WTM Privacy Report</ui-text>
                    <ui-text
                      type="body-m"
                      mobile-type="body-s"
                      color="secondary"
                    >
                      Generated by tracking the trackers in a browser protected
                      by Ghostery. The statistics here provide transparency
                      about web tracking.
                    </ui-text>
                  </div>
                </a>
